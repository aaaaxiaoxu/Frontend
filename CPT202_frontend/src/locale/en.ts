const en={
  message:{
    ...
    exploreGenres: 'Explore music genres...',
        ...
        pleaseSelectMusic: 'Please select a music file',
        editMusicInfo: 'Edit Music Information',
    musicName: 'Music Name',
    enterMusicName: 'Enter music name',
    artist: 'Artist',
    enterArtist: 'Enter artist name',
    album: 'Album',
    enterAlbum: 'Enter album name',
    category: 'Category',
    ...
    musicIdMissing: 'Music ID is missing',
    failedToGetTagsAndCategories: 'Failed to get tags and categories',
    // ...


    uploading: 'Uploading...',
    pleaseUploadAudioFile: 'Please upload an audio file!',
    ...
    resourceApproved: 'Resource approved',
    ...
    getDetailError: 'Error getting details',
    error: 'Error',
    noPlayableMusic: 'No playable music data',
    musicUrlNotExist: 'Music URL does not exist, cannot play',
    nowPlaying: 'Now playing',
    playFailed: 'Play failed, please try again',
    parseTagsFailed: 'Failed to parse tags',
    // MusicPage 组件相关
    uploaded: 'Uploaded',
    ...
    errorFetchingMusicData: 'Error fetching music data',
    navigatingToDetail: 'Navigating to detail page, music ID',
    invalidMusicId: 'Invalid music ID',
    // 添加分类组名称
    internationalPop: 'International Pop',
    electronicMusic: 'Electronic Music',
    rockAndAlternative: 'Rock & Alternative',
