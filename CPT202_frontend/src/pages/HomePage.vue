  ...
  <div class="home-page">
    ...
    <div class="popular-music">
      <div class="container">
        ...
        <div class="view-more">
          <a-button type="primary" @click="goToMusic">查看更多</a-button>
        </div>
      </div>
    </div>
    ...
    <div class="stats-section">
      <div class="container">
        <div class="stats-grid">
          <div class="stat-item">
            <div class="stat-number">{{ stats.musicCount }}</div>
