          ...
          <div class="relative mx-auto w-full max-w-xl space-y-4">
            ...
            <template v-if="!files.length">
              <div class="upload-box-container">
                <Motion
                  as="div"
                  class="upload-box relative z-40 mx-auto flex items-center justify-center rounded-md bg-white shadow-[0px_10px_50px_rgba(0,0,0,0.1)] group-hover/file:shadow-2xl dark:bg-neutral-900"
                  :initial="{
                    x: 0,
                    y: 0,
                    opacity: 1,
                ...
                <div
                  class="absolute inset-0 z-30 mx-auto flex items-center justify-center rounded-md border border-dashed border-sky-400 bg-transparent transition-opacity"
