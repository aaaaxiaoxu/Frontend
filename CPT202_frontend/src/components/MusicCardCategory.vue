  ...
  <div class="music-card-component">
    ...
    <div v-else-if="detail" class="music-card">
      ...
      <div class="music-info">
        ...
        <!-- 类别显示 -->
        <div v-if="displayCategory" class="category-section">
          <span class="category-label">Category:</span>
          <span class="category-tag" :class="getCategoryClass(displayCategory)">
            {{ displayCategory }}
          </span>
        </div>
        ...
        <div class="tags-container">
          <span v-if="!parsedTags.length" class="no-tags">暂无标签</span>
...
// 如果想同时显示 API 返回的 category 和传入的 category，可以使用计算属性
const displayCategory = computed(() => {
  return props.category || (detail.value?.category || '');
});
</script>
